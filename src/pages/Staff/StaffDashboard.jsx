...
function StaffDashboard() {
  ...
  return (
    <div>
      ...
      <div className='w-full h-[70vh] flex flex-col gap-8 lg:gap-11 items-center justify-start mt-6'>

        <div className='flex flex-wrap p-2'>
          <h6 className='flex items-center gap-2 text-md font-semibold text-zinc-500'><Calendar size={16}/> {currentTime.toLocaleString('en-IN', {dateStyle: 'medium', timeStyle: 'short', })} </h6>
        </div>
        ...
        <h6 className='text-sm text-center text-zinc-400'>&copy; Developed By Thincnext</h6>
      </div>
