  ...
  return (
    <div className='flex items-center justify-center gap-8 flex-wrap'>
        ...
        <div className='font-semibold text-wrap'>
            ...
            <h2 className='text-2xl md:text-3xl font-bold text-blue-500 mt-1 text-left'>{stats.totalVisitors}</h2> 
        </div>
        ...
        <div className='font-semibold text-wrap'>
            ...
            <h2 className='text-2xl md:text-3xl font-bold text-green-500 mt-1 text-left'>{stats.checkedInVisitors}</h2> 
        </div>
        <div className='flex items-center'>
        ...
        <div className='flex justify-between items-center w-75 md:w-100 md:h-25 text-center border-gray-300 border rounded-lg shadow-sm p-6'>
        <div className='font-semibold text-wrap'>
            <h2 className='text-lg md:text-xl text-gray-600'>Average Duration </h2>
            <h2 className='text-2xl md:text-3xl font-bold text-gray-600 mt-1 text-left'>{ formatMinutes(stats.avgDuration)}</h2> 
        </div>
        <div className='flex items-center'>
