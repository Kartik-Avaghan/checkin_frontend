  ...
  return (
    <div>
      ...
      {data.length > 0 ? (
            ...
            >
              ...
              {v.checkoutTime && (
                <div className="text-sm mt-1 flex items-center gap-1">
                  <Clock4 size={16} /> Duration:{" "}
                  {v.checkoutTime ? formatMinutes(v.duration) : "-"}
                </div>
              )}
        ...
        <div className="lg:hidden flex items-center justify-center gap-2 mt-10 text-xl text-gray-800 font-medium">
      ...
      {data.length > 0 ? (
        ...
        <div className="hidden lg:flex items-center justify-center gap-3 mt-20 text-3xl text-gray-800 font-medium">
